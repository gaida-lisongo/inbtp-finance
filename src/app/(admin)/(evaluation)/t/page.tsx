...
export const metadata: Metadata = {
  title: "Titulaire | Dashboard Agents",
  description: "Page metier dediee a l'autorisation Titulaire.",
};

type TitulairePageProps = {
...
export default async function TitulairePage({ searchParams }: TitulairePageProps) {
    ...
    <div>
      ...
      <div className="space-y-6">
        <ComponentCard
          ...
          desc="Point d'entree du metier Titulaire."
        >
