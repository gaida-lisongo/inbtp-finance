...
export const metadata: Metadata = {
  ...
  description: "Page metier dediee a l'autorisation Secretaire.",
};

type SecretairePageProps = {
...
export default async function SecretairePage({ searchParams }: SecretairePageProps) {
    ...
    <div>
      ...
      <div className="space-y-6">
        <ComponentCard
          ...
          desc="Point d'entree du metier Secretaire."
        >
