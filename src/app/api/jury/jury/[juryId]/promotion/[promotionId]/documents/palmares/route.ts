...
import DocumentPalmares from "@/utils/excel/DocumentPalmares";
...
export async function GET(
  ...
  const document = new DocumentPalmares();
  ...
  const filename = slugify(`palmares-${programme.designation ?? "promotion"}`) || "palmares";
