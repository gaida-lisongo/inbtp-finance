...
export default function SignUpForm({ error, nextPath }: SignUpFormProps) {
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs dark:border-gray-800 dark:bg-white/[0.03] sm:p-8">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Le compte n&apos;est autorise que si votre email existe deja dans la table `students`.
            </p>
          </div>
          ...
          <form action={signUpStudentAction} className="space-y-5">
            ...
            <div>
              <Label htmlFor="signup-email">
                Email etudiant<span className="text-error-500">*</span>
              </Label>
              <Input id="signup-email" name="email" type="email" placeholder="prenom.nom@exemple.com" />
            </div>
            ...
            <div>
              ...
              <Input id="signup-password" name="password" type="password" placeholder="Minimum 6 caracteres" />
            </div>
